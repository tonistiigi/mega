...
},{"buffer":2,"mega":3,"reactive":4,"emitter":5,"jquery-browserify":6,"__browserify_process":7}],7:[function(require,module,exports){// shim for using process in browser
...
},{}],2:[function(require,module,exports){function SlowBuffer (size) {
    this.length = size;
};
...
},{"assert":8,"base64-js":9,"./buffer_ieee754":10}],8:[function(require,module,exports){// UTILITY
...
},{"util":11,"buffer":2}],11:[function(require,module,exports){var events = require('events');
...
},{"events":12}],12:[function(require,module,exports){(function(process){if (!process.EventEmitter) process.EventEmitter = function () {};
...
},{"__browserify_process":7}],9:[function(require,module,exports){(function (exports) {
	'use strict';
...
},{}],10:[function(require,module,exports){exports.readIEEE754 = function(buffer, offset, isBE, mLen, nBytes) {
  var e, m,
...
},{}],3:[function(require,module,exports){(function(process){var parse = require('url').parse
...
},{"url":13,"through":14,"stream-combiner":15,"./crypto":16,"./util":17,"crypto":18,"./storage":19,"./file":20,"__browserify_process":7}],13:[function(require,module,exports){var punycode = { encode : function (s) { return s } };
...
},{"querystring":21}],21:[function(require,module,exports){var isArray = typeof Array.isArray === 'function'
    ? Array.isArray
    : function (xs) {
        return Object.prototype.toString.call(xs) === '[object Array]'
    };
...
},{}],14:[function(require,module,exports){(function(process){var Stream = require('stream')
...
},{"stream":22,"__browserify_process":7}],22:[function(require,module,exports){var events = require('events');
var util = require('util');
...
},{"events":12,"util":11}],15:[function(require,module,exports){var duplexer = require('duplexer')
...
},{"duplexer":23}],23:[function(require,module,exports){var Stream = require("stream")
...
},{"stream":22}],16:[function(require,module,exports){var EventEmitter = require('events').EventEmitter
...
},{"events":12,"util":11,"./sjcl":24}],24:[function(require,module,exports){/** @fileOverview Low-level AES implementation.
 *
...
},{}],17:[function(require,module,exports){var through = require('through')
...
},{"through":14}],18:[function(require,module,exports){var sha = require('./sha')
var rng = require('./rng')
var md5 = require('./md5')
...
},{}],26:[function(require,module,exports){// Original code adapted from Robert Kieffer.
...
},{}],19:[function(require,module,exports){var EventEmitter = require('events').EventEmitter
var inherits = require('util').inherits
var pipeline = require('stream-combiner')
var crypto = require('./crypto')
...
},{"events":12,"util":11,"stream-combiner":15,"./crypto":16,"./crypto/rsa":28,"./api":29,"./file":20,"./mega":3,"request":30,"through":14,"./util":17,"crypto":18}],28:[function(require,module,exports){/* RSA public key encryption/decryption
...
},{}],29:[function(require,module,exports){var EventEmitter = require('events').EventEmitter
var inherits = require('util').inherits
var request = require('request')
...
},{"events":12,"util":11,"request":30,"querystring":21}],30:[function(require,module,exports){(function(process){// Copyright 2010-2012 Mikeal Rogers
//
...
},{"http":31,"url":13,"util":11,"stream":22,"querystring":21,"./mimetypes":32,"./oauth":33,"./uuid":34,"./forever":35,"./vendor/cookie":36,"./vendor/cookie/jar":37,"./tunnel":38,"./aws":39,"https":40,"tls":41,"__browserify_process":7}],31:[function(require,module,exports){var http = module.exports;
...
},{"stream":22,"util":11}],32:[function(require,module,exports){// from http://github.com/felixge/node-paperboy
exports.types = {
  "3gp":"video/3gpp",
  "aiff":"audio/x-aiff",
...
},{}],33:[function(require,module,exports){var crypto = require('crypto')
  , qs = require('querystring')
  ;
...
},{"crypto":18,"querystring":21}],34:[function(require,module,exports){module.exports = function () {
...
},{}],35:[function(require,module,exports){module.exports = ForeverAgent
...
},{"util":11,"http":31,"net":45,"tls":41,"https":40}],45:[function(require,module,exports){// todo

},{}],41:[function(require,module,exports){// todo

},{}],40:[function(require,module,exports){var http = require('http');
...
},{"url":13}],37:[function(require,module,exports){/*!
* Tobi - CookieJar
* Copyright(c) 2010 LearnBoost <dev@learnboost.com>
* MIT Licensed
*/
...
},{"url":13}],38:[function(require,module,exports){(function(process){'use strict';
...
},{"net":45,"tls":41,"http":31,"https":40,"events":12,"assert":8,"util":11,"__browserify_process":7}],39:[function(require,module,exports){
/*!
 * knox - auth
 * Copyright(c) 2010 LearnBoost <dev@learnboost.com>
 * MIT Licensed
...
},{"crypto":18,"url":13}],20:[function(require,module,exports){(function(process){var EventEmitter = require('events').EventEmitter
var inherits = require('util').inherits
var request = require('request')
var crypto = require('./crypto')
var API = require('./api').API
...
},{"debug":46,"./binding":47,"./bindings":48}],46:[function(require,module,exports){
/**
...
},{"format-parser":49}],49:[function(require,module,exports){
/**
...
},{"event":50,"classes":51}],50:[function(require,module,exports){
/**
...
},{}],5:[function(require,module,exports){(function(process){var asynclist = require('asynclist'),
...
},{"asynclist":53,"util":11,"__browserify_process":7}],53:[function(require,module,exports){(function(process){var eventproxy = require('eventproxy').EventProxy;
...
},{"eventproxy":54,"__browserify_process":7}],54:[function(require,module,exports){module.exports = require('./lib/eventproxy');

},{"./lib/eventproxy":55}],55:[function(require,module,exports){(function(){/*global exports */
/*!
...
},{}],6:[function(require,module,exports){(function(global){// Uses Node, AMD or browser globals to create a module.
